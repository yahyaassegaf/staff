...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Administrasi Keuangan</title>
...
<body>
    ...
    <!-- ISI -->
    <div class="paragraf">
        Mahasiswa tersebut benar-benar aktif dan telah memenuhi segala persyaratan
        administrasi umum (Pelunasan keuangan) antara lain:
    </div>

    <div class="list-persyaratan">
        <ol>
            <li>Telah melunasi Uang Pendaftaran;</li>
            <li>Telah melunasi SPP sampai semester terakhir;</li>
            <li>Telah melunasi biaya KKN dan PPL;</li>
            <li>Telah melunasi biaya ujian skripsi.</li>
        </ol>
    </div>
