            ...
            <div class="col-xl-12">
                <ShowcodeCard :code="prism.buttonswithDropdowns" title="Buttons addons">
                    ...
                    <div class="input-group mb-3">
                        <button class="btn btn-primary" type="button">Button</button>
                        <button class="btn btn-primary" type="button">Button</button>
                        <input type="text" class="form-control px-sm-3 px-1" placeholder="" aria-label="Example text with two button addons">
                    </div>
                    <div class="input-group">
            ...
            <div class="col-xl-12">
                <ShowcodeCard :code="prism.buttonsAddons" title="Buttons with dropdowns">
                    ...
                    <div class="input-group flex-nowrap">
                        <button class="btn btn-primary-transparent dropdown-toggle px-2 px-sm-3" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
                        <ul class="dropdown-menu">
                        ...
                        <input type="text" class="form-control" aria-label="Text input with 2 dropdown buttons border-end-0">
                        <button class="btn btn-primary-transparent dropdown-toggle px-1 px-sm-3 custom-group" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="javascript:void(0);">Action</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);">Another action</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);">Something else here</a></li>
            ...
            <div class="col-xl-12">
                <ShowcodeCard :code="prism.customfileInput" title="Custom file input">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="file" class="form-control py-1" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                    </div>
