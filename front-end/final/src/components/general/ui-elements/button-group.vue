...
<div class="row">
    ...
    <div class="col-xl-6">
        <ShowcodeCard title="Checkbox button groups" :code="prism.CheckboxButtonGroups" custom-card-body-class="checkbox-button-group">
    ...
    <div class="col-xl-6">
        <ShowcodeCard title="Radio button groups" :code="prism.RadioButtonGroups" custom-card-body-class="radio-button-group">
    ...
    <div class="col-xl-12">
        <ShowcodeCard title="Social Group Buttons" :code="prism.SocialGroupButtons">
            <div class="btn-group" role="group" aria-label="Basic example">
                <button class="btn btn-icon btn-facebook btn-wave align-middle">
                    <i class="ri-facebook-line"></i>
                </button>
                <button class="btn btn-icon btn-twitter btn-wave align-middle">
                    <i class="ri-twitter-x-line"></i>
                </button>
                <button class="btn btn-icon btn-instagram btn-wave align-middle">
                    <i class="ri-instagram-line"></i>
                </button>
                <button class="btn btn-icon btn-github btn-wave align-middle">
                    <i class="ri-github-line"></i>
                </button>
                <button class="btn btn-icon btn-youtube btn-wave align-middle">
                    <i class="ri-youtube-line"></i>
                </button>
                <button class="btn btn-icon btn-google btn-wave align-middle">
