  ...
  <header class="app-header sticky" id="header">
    ...
    <div class="main-header-container container-fluid">
      ...
      <ul class="header-content-right">
          ...
          >
            <div class="p-3 bg-primary text-fixed-white">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <router-link
                  to="/dashboards/ecommerce/products/"
                      ...
                      >
                        <div class="fs-14 fw-medium w-75">
                          <div class="text-truncate">
                            <router-link to="/dashboards/ecommerce/cart/"
                              >{{ item.name }}
                            </router-link>
                          </div>
            ...
            <div
              class="p-3 empty-header-item border-top"
              v-if="notificationNotes.length"
            >
              <div class="text-center d-grid">
                <router-link
                  to="/dashboards/ecommerce/checkout/"
        ...
        <!-- <li
          class="header-element notifications-dropdown d-xl-block d-none dropdown"
        >
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li>
                <router-link
                  ...
                  class="dropdown-item d-flex align-items-center"
                  ><i class="ti ti-logout me-2 fs-18"></i>Log Out</router-link
                >
              </li>
            </ul>
          </div>
