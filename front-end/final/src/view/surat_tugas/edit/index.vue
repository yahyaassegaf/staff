      ...
      try {
        ...
        if (response.data.status) {
          ...
          suratData.value = {
            ...
            nomor: data.nomor || "",
            pebimbing1: data.pebimbing1 || "",
            alamat_pebimbing1: data.alamat_pebimbing1 || "",
            tugas_pebimbing1: data.tugas_pebimbing1 || "",
            pebimbing2: data.pebimbing2 || "",
            alamat_pebimbing2: data.alamat_pebimbing2 || "",
            tugas_pebimbing2: data.tugas_pebimbing2 || "",
