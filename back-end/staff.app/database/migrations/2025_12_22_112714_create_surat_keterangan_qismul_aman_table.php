...
return new class extends Migration
{
    ...
    {
        Schema::create('surat_keterangan_qismul_aman', function (Blueprint $table) {
            $table->id();
            $table->string('nomor_surat');
            $table->string('ketua')->nullable(); // Ketua Qismul Aman Ma’had
    ...
    {
        Schema::dropIfExists('surat_keterangan_qismul_aman');
    }
};
