...
export const Columndynamixoptions = {
    ...
    dataLabels: {
        ...
        formatter: function (_val: string, opt: { w: { globals: { labels: { [x: string]: number; }; }; }; dataPointIndex: string | number; }) {
...
export const optionsQuarter = {
    ...
    tooltip: {
        x: {
            formatter: function (_val: string, opts: { w: { globals: { seriesNames: { [x: string]: number; }; }; }; seriesIndex: string | number; }) {
