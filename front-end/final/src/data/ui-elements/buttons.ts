...
interface SocialIconButtonType {
    id: number;
    class: string;
    class1?: string;
    color?: string
...
export let
    ...
    GradientButtons: ButtonDataType[] = [
    ...
    SocialIconButtons: SocialIconButtonType[] = [
    ...
    ColoredButtons: SocialIconButtonType[] = [
        { id: 1, class: "primary" },
    ...
    LabelButtons: SocialIconButtonType[] = [
