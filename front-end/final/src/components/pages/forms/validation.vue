...
<script lang="ts">
import * as prism from '../../../data/prismCode/forms/formvalidation.ts';
...
export default {
    ...
    methods: {
        checkForm(e: Event) {
            this.errors = [];
            if (!this.firstname) this.errors.push({
                'firstname': "First Name required."
            });
            if (!this.lastname) this.errors.push({
                'lastname': "Last Name required."
            });
            if (!this.username) this.errors.push({
                'username': "UserName required."
            });
            if (!this.city) this.errors.push({
                'city': "City required."
            });
            if (!this.state) this.errors.push({
                'state': "State required."
            });
            if (!this.zip) this.errors.push({
                'zip': "Zip required."
            });
            if (!this.agree) this.errors.push({
                'agree': "agree required."
            });
            e.preventDefault();
        },
    }
