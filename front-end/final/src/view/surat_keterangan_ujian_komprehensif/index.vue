...
export default defineComponent({
  ...
  setup() {
    ...
    const headers = [
      ...
      { text: "NIM", value: "nim", sortable: true, width: 200 },
      { text: "Nama Lengkap", value: "nama_lengkap", sortable: true, width: 250 },
      { text: "Nama Prodi", value: "nama_prodi", sortable: true, width: 200 },
      { text: "Kelas Pondok", value: "kelas_pondok", sortable: true, width: 200 },
    ...
    async function getData() {
      try {
        loading.value = true;
        const response = await apiGet("/skukd", {
        ...
        const rows = Array.isArray(respData.data.data)
          ? respData.data.data
          : [];
        const startNo =
    ...
    function edit(params: any) {
      router.push(`/skukd/edit/${params.id}`);
    }
    ...
    async function remove(params: any) {
      ...
      try {
        const response = await apiDelete("/skukd/" + params.id);
  ...
  <div class="container-fluid">
    ...
    >
      <h1 class="page-title fw-semibold fs-18 mb-0">
        Surat Keterangan Ujian Komprehensif Diniyah
      </h1>
      <div class="ms-md-1 ms-0">
        <nav>
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">SKUKD</li>
          </ol>
        </nav>
      </div>
    </div>
