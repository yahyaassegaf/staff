...
class Mahasiswa
{
     ...
     */
    public static function all($offset = null, $limit = null, $search = null, $order = null, $dir = null, $where = null, $pluck = null, $is_semester_aktif = true)
    {
        $post = [
            'offset' => $offset,
            'limit' => $limit,
    ...
    public static function cekPelanggaran($nim)
    {
     ...
     public static function Semester($offset = null, $limit = null, $search = null, $order = null, $dir = null, $where = null, $pluck = null,$is_semester_aktif = true)
    {
        $post = [
            'offset' => $offset,
            'limit' => $limit,
