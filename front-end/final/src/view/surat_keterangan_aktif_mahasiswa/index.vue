...
export default defineComponent({
  ...
  setup() {
    ...
    async function getData() {
      try {
        loading.value = true;
        const response = await apiGet("/skam", {
    ...
    function edit(params: any) {
      router.push(`/skam/edit/${params.id}`);
    }
      ...
      <div class="ms-md-1 ms-0">
        <nav>
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">SKAM</li>
          </ol>
        </nav>
      </div>
    </div>
