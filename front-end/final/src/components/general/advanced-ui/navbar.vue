        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <nav class="navbar bg-light mb-3">
                    <div class="container-fluid">
                        <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="/images/brand-logos/toggle-logo.png" alt=""></a>
                    </div>
                </nav>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                <nav class="navbar bg-light mb-3">
                    <div class="container-fluid">
                        <a aria-label="anchor" class="navbar-brand"><img src="/images/brand-logos/toggle-logo.png" alt=""></a>
                        <form class="d-flex" role="search">
                            <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
                            <button class="btn btn-primary" type="submit">Search</button>
                        </form>
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                <nav class="navbar navbar-expand-lg navbar-secondary mb-3">
                    <div class="container-fluid">
                        <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="/images/brand-logos/toggle-dark.png" alt=""></a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarScroll">
                            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link disabled" href="javascript:void(0);" tabindex="-1" aria-disabled="false">Link</a>
                                </li>
                            </ul>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link disabled" href="javascript:void(0);" tabindex="-1" aria-disabled="false">Disabled</a>
                                </li>
                            </ul>
                            <form class="d-flex">
                                <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
