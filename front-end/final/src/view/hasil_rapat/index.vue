...
export default defineComponent({
  ...
  setup() {
    ...
    const headers = [
      ...
      { text: "Agenda", value: "agenda", sortable: true },
      { text: "Tanggal", value: "tanggal", sortable: true },
      { text: "Tempat", value: "tempat", sortable: true },
    ...
    async function getData() {
      try {
        loading.value = true;
        const response = await apiGet("/hasil-rapat", {
    ...
    function edit(params: any) {
      router.push(`/hasil-rapat/edit/${params.id}`);
    }
    ...
    async function download(params: any) {
      try {
        const res = await apiPdf(
          `/hasil-rapat/download-pdf/${params.id}`,
          {},
          { responseType: "blob" }
        );
...
<template>
  <div class="container-fluid">
    ...
    >
      <h1 class="page-title fw-semibold fs-18 mb-0">Hasil Rapat</h1>
        ...
        <div class="col-md-3 ms-auto">
          <div class="input-group">
            <input
              ...
              v-model="searchValue"
              placeholder="Cari (Agenda/Tempat)..."
            />
      ...
      >
        ...
        <template #item-status="item">
          ...
          <span
            ...
            >Failed</span
          >
          <span v-else class="badge bg-warning-transparent">Pending</span>
        </template>
