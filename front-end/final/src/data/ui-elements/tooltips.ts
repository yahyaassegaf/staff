interface TooltipDirectionType {
    id: number;
    text: string;
}

interface ColoredTooltipType {
    id: number;
    dir: string;
    color: string;
    text: string;
...
export let
    Tooltipdirtooltip: TooltipDirectionType[] = [
        { id: 1, text: "top" },
        { id: 2, text: "right" },
        { id: 3, text: "bottom" },
        { id: 4, text: "left" }
    ],
    Coloredtooltip: ColoredTooltipType[] = [
