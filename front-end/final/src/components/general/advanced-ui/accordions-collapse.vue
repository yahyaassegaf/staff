...
import * as prism from '../../../data/prismCode/advancedUi/accordion.ts';
...
<div class="row">
    ...
    <div class="col-xl-12">
        <ShowcodeCard :code="prism.alwaysOpenAccordion" title="Always Open Accordion<p class='text-muted subtitle fs-12 fw-normal'>Omit the <code>data-bs-parent</code>  attribute on each<code>.accordion-collapse</code>  to make accordion items stay open when another item is opened.</p>">
...
<div class="row">
    <div class="col-xl-12">
        <ShowcodeCard :code="prism.example" title="Example">
            <p class="mb-0">
                <a class="btn btn-primary collapsed mb-2 me-1" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                    Link with href
                </a>
    ...
    <div class="col-xl-12">
        <ShowcodeCard :code="prism.targetsCollapse" title="Targets Collapse">
            <p class="mb-0">
                <a class="btn btn-primary mb-2 me-1" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Toggle first element</a>
                <button class="btn btn-success mb-2 me-1" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Toggle second
                    element</button>
