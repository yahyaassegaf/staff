...
<div class="row">
    <div class="col-xl-6">
        <div class="row">
            <div class="col-xl-12">
                <ShowcodeCard title="TEXT SELECTION" customCardHeaderClass="justify-content-between" :code="prism.textSlection">
            ...
            <div class="col-xl-12">
                <ShowcodeCard title="POINTER EVENTS" customCardHeaderClass="justify-content-between" :code="prism.pointerevents">
            ...
            <div class="col-xl-12">
                <ShowcodeCard title=" LINK OPACITY " customCardHeaderClass="justify-content-between" :code="prism.linkOpacity">
            ...
            <div class="col-xl-12">
                <ShowcodeCard title="LINK HOVER VARIANT" customCardHeaderClass="justify-content-between" :code="prism.linkHoverVariant">
            ...
            <div class="col-xl-12">
                <ShowcodeCard title=" LINK UNDERLINE COLORS " customCardHeaderClass="justify-content-between" :code="prism.linkUnderlineColors">
    ...
    <div class="col-xl-6">
        <div class="row">
            <div class="col-xl-12">
                <ShowcodeCard title="LINK UNDERLINE OFFSET" customCardHeaderClass="justify-content-between" :code="prism.linkUnderlineOffset">
            ...
            <div class="col-xl-12">
                <ShowcodeCard title=" LINK UNDERLINE OPACITY" customCardHeaderClass="justify-content-between" :code="prism.linkUnderlineOpacity">
            ...
            <div class="col-xl-12">
                <ShowcodeCard title=" LINK HOVER OPACITY " customCardHeaderClass="justify-content-between" :code="prism.linkHoverOpacity">
            ...
            <div class="col-xl-12">
                <ShowcodeCard title=" COLORED LINKS " customCardHeaderClass="justify-content-between" :code="prism.coloredLinks">
