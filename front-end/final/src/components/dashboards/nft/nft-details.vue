...
import * as NftDetailsData from "../../../data/dashboards/nft/nftdetailsdata.ts";
import { ref } from "vue";
                    ...
                    <div class="col-xxl-4 col-xl-12">
                        <div class="row">
                            <div class="col-xxl-12 col-sm-12 mb-md-5 mb-3">
                                ...
                                }" :spaceBetween="10" :navigation="true" :thumbs="{ swiper: thumbsSwiper }" :modules="modules" class="swiper swiper-preview-details bg-light product-details-page">
                                    <swiper-slide><img class="img-fluid rounded" src="/images/nft-images/14.png" /></swiper-slide>
                                    <swiper-slide><img class="img-fluid rounded" src="/images/nft-images/13.png" /></swiper-slide>
                                    <swiper-slide><img class="img-fluid rounded" src="/images/nft-images/12.png" /></swiper-slide>
                                    <swiper-slide><img class="img-fluid rounded" src="/images/nft-images/10.png" /></swiper-slide>
                                </swiper>
                                <swiper :autoplay="true" @swiper="setThumbsSwiper" :spaceBetween="10" :slidesPerView="4" :freeMode="true" :watchSlidesProgress="true" :modules="modules" class="swiper swiper-view-details mt-2">
                                    <swiper-slide><img class="img-fluid" src="/images/nft-images/14.png" /></swiper-slide>
                                    <swiper-slide><img class="img-fluid" src="/images/nft-images/13.png" /></swiper-slide>
                                    <swiper-slide><img class="img-fluid" src="/images/nft-images/12.png" /></swiper-slide>
                                    <swiper-slide><img class="img-fluid" src="/images/nft-images/10.png" /></swiper-slide>
                                </swiper>
                            ...
                            <div class="col-xxl-12 col-sm-12 d-md-block d-none">
                                ...
                                <ul class="list-group">
                                    <li :class="`list-group-item ${idx.liClass}`" v-for="(idx) in NftDetailsData.NftList" :key="idx.id">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-xs avatar-rounded lh-1 me-1"><img src="/images/faces/9.jpg" alt=""></span>
                                                PixelWarrior
                                            </div>
                                        </div>
                                                ...
                                                <div class="nft-assurance">
                                                    <p class="mb-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                                                            ...
                                                            <path fill="var(--primary-color)" d="M53 26V13.4L32 1.9 11 13.4v25.2l21 11.6 21-11.5V33h-2v4.4L32 47.9l-13-7.2V19l12 6.6V45h2V25.6l18-9.9V26h2zm-3.1-12L32 23.9l-11.9-6.6 17.7-10L49.9 14zM35.6 6.1 18 16.2 14.1 14 32 4.1l3.6 2zM17 39.6l-4-2.2V15.7l4 2.2v21.7z" />
                                                            <linearGradient id="b" x1="35.769" x2="35.769" y1="63.723" y2=".835" gradientTransform="matrix(1 0 0 -1 0 63.89)" gradientUnits="userSpaceOnUse">
                                                                <stop offset="0" stop-color="var(--primary-color)" />
                                                                <stop offset="1" stop-color="#2c98b5" />
                                                            </linearGradient>
                                                            <path fill="var(--primary-color)" d="M38 26v2h6c7.2 0 13 5.8 13 13s-5.8 13-13 13H16.4l5.3-5.3-1.4-1.4-7.8 7.7 8.8 7.7 1.3-1.5-6-5.2H44c8.3 0 15-6.7 15-15s-6.7-15-15-15h-6z" />
                                                        </svg>
                                                    </p>
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-xl-7">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered text-nowrap product-details-table">
                                                        <tbody>
                                                            <tr v-for="(idx) in NftDetailsData.NftData" :key="idx.id">
                                            ...
                                            <div class="col-xl-5">
                                                ...
                                                <ul class="mb-0 ps-3">
                                                    <li class="text-muted mb-2" v-for="(idx) in NftDetailsData.NftInfo" :key="idx.id">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-4 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <div :class="`d-flex align-items-center ${idx.class}`" v-for="(idx) in NftDetailsData.NftRatings" :key="idx.id">
                                                    <div class="fs-12 me-2 fw-medium">{{ idx.stars }} <i class="ri-star-fill fs-10"></i></div>
                                                    <div class="progress progress-xs flex-fill">
                                                        <div :class="`progress-bar bg-${idx.color}`" role="progressbar" :style="`width: ${idx.percentage}%`" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-sm-flex d-block align-items-top mb-3">
                                                        <div class="d-flex flex-fill">
                                                            ...
                                                            <div class="lh-1 me-2">
                                                                ...
                                                                <div class="mb-1">
                                                                    <i class="ri-star-fill text-warning align-middle fs-12 me-1"></i>
                                                                    <i class="ri-star-fill text-warning align-middle fs-12 me-1"></i>
                                                                    <i class="ri-star-fill text-warning align-middle fs-12 me-1"></i>
                                                                    <i class="ri-star-fill text-warning align-middle fs-12 me-1"></i>
