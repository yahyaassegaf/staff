...
const formatParts = computed(() => {
  ...
  return parseToParts(getFormat(11));
});
...
watch(
  ...
  async (val) => {
    ...
    form.periode_bulan = val.periode_bulan ?? "";
    form.alasan = val.alasan ?? "";
        ...
        <div class="card custom-card">
          <div class="card-header">
            <div class="card-title">
              {{ isEdit ? "Edit" : "Tambah" }} Surat Keterangan
            </div>
          </div>
          <div class="card-body">
            <div class="row gy-3">
              ...
              <div class="col-xl-4">
                ...
                <input
                  v-else
                  type="month"
                  v-model="form.periode_bulan"
                  class="form-control"
                  :class="{ 'is-invalid': errors?.periode_bulan }"
                  placeholder="Isikan Periode Bulan"
                />
                <div v-if="errors?.periode_bulan" class="invalid-feedback">
                  {{ errors.periode_bulan[0] }}
                </div>
              </div>
              ...
              <div class="col-xl-12">
                ...
                <textarea
                  ...
                  v-model="form.alasan"
                  class="form-control"
                  :class="{ 'is-invalid': errors?.alasan }"
                  rows="3"
                  placeholder="Isikan Alasan"
                ></textarea>
                <div v-if="errors?.alasan" class="invalid-feedback">
                  {{ errors.alasan[0] }}
                </div>
              </div>
