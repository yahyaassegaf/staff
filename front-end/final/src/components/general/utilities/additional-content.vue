        ...
        <div class="card custom-card">
            ...
            <div class="card-body overflow-x-auto">
                ...
                <div style="height: 100px; background-color: rgba(255,0,0,0.1);" class="d-flex">
                    <div class="h-25 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding-inline:10px;">H 25%
                    </div>
                    <div class="h-50 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H 50%
                    </div>
                    <div class="h-75 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H 75%
                    </div>
                    <div class="h-100 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H 100%
                    </div>
                    <div class="h-auto d-sm-inline-block d-none" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H auto
                    </div>
                </div>
            </div>
        </div>
