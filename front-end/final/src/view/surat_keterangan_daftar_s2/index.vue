...
export default defineComponent({
  ...
  setup() {
    ...
    const headers = [
      ...
      { text: "Program Studi", value: "prodi", sortable: true },
    ...
    async function getData() {
      try {
        loading.value = true;
        const response = await apiGet("/skds2", {
    ...
    function edit(params: any) {
      router.push(`/skds2/edit/${params.id}`);
    }
