                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        <div class="p-3 bg-primary text-fixed-white">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <router-link to="/dashboards/ecommerce/products/"
                                            ...
                                            <div class="d-flex align-items-start justify-content-between mb-3">
                                                <div class="fs-14 fw-medium w-75">
                                                    <div class="text-truncate">
                                                        <router-link to="/dashboards/ecommerce/cart/">{{ item.name }}
                                                        </router-link>
                                                    </div>
                        ...
                        <div class="p-3 empty-header-item border-top" v-if="notificationNotes.length">
                            <div class="text-center d-grid">
                                <router-link to="/dashboards/ecommerce/checkout/" class="btn btn-primary btn-wave">
                                    Proceed to
        ...
        <li class="header-element dropdown">
            ...
            <div class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li>
                        <router-link to="/pages/authentication/sign-up/basic" class="dropdown-item d-flex align-items-center"><i
